...
const Sidebar = () => {
  const styles = {
    ...
    logoStyle: `mr-4 flex object-cover`,
  ...
  const { isAuthenticated, nickname, setNickname, username, handleUsername } =
    useContext(MagazineContext);
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.companyName}>
        <Image src={logoFull} alt="logoFull" height={100} width={100} />
      </div>
    </div>
  );
};
